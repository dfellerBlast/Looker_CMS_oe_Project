...
-- SELECT * FROM etl_enroll ORDER BY year, week_of_year
 ...
 AND (start_date BETWEEN '2021-10-01' AND '2021-10-14' OR start_date BETWEEN '2020-10-01' AND '2020-10-14')
...
-- SELECT * FROM medigap_wizard_agg ORDER BY year, week_of_year
 ...
 FROM user_agg_2021
 LEFT JOIN session_agg_2021 ON session_agg_2021.week_of_year = user_agg_2021.week_of_year
